...
人机对战,7 个可选英雄,完整格斗机制(连锁/方向格挡/护条破防/浮空连段/超必演出)+ 练习场 + 招式图鉴。
...
7 位奥特曼英雄,分两套操作框架(帧数据/连招/平衡完全同基线,只换主题色与立绘):

- **力量系**(重击大伤害,一套连段定胜负):**ULTRAMAN 初代**(红)· **TARO 泰罗**(橙)· **GAIA 盖亚**(绯红)。
- **速度系**(移速手长占优,飞行道具立回,瞬身背刺超必):**ZERO 赛罗**(紫)· **TIGA 迪迦**(魅紫)· **DYNA 戴拿**(青)· **Z 泽塔**(蓝)。
